...
%			informaci\'on\\[6pt]
	...
	\todo{muchas de estas cosas ya no se hacen asi}
	...
	\begin{center}
		\includegraphics[width=10cm]{cranfield_vector}
		
		\includegraphics[width=10cm]{vaswani_vector}
		
		\includegraphics[width=10cm]{cord19_vector}
	\end{center}
